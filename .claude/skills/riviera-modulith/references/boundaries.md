...
all nine bounded-context modules and of the two non-context ones — `shared` (OPEN Shared
Kernel) and `challenge` (closed, full template, ADR-0017, whose list is empty); keep it that
way):
