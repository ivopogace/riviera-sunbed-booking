 ...
 * which imports this plus {@code SynchronousMailDispatch}. That bundling is deliberate: since
 ...
 * whose whole subject is that the real, fully-wired {@code MailSender} dispatches off the
 ...
 * inline I/O would pass all of them while re-opening the async-dispatch timing oracle.
 *
