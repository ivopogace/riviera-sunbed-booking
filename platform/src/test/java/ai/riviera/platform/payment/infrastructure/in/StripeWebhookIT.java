...
class StripeWebhookIT {
	...
	void verifiedSucceededConfirmsBooking() throws Exception {
		payments.record(new NewPayment(new BookingRef(7001L), "pi_hook_ok", 4500L, "EUR"));
	...
	void badSignatureRejectedNoConfirm() throws Exception {
		payments.record(new NewPayment(new BookingRef(7002L), "pi_hook_badsig", 4500L, "EUR"));
	...
	void duplicateDeliveryIsIdempotent() throws Exception {
		payments.record(new NewPayment(new BookingRef(7003L), "pi_hook_dup", 4500L, "EUR"));
	...
	void outOfOrderIsSafe() throws Exception {
		...
		payments.record(new NewPayment(new BookingRef(7004L), "pi_hook_other", 4500L, "EUR"));
	...
	void canceledPublishesPaymentCanceled() throws Exception {
		payments.record(new NewPayment(new BookingRef(7005L), "pi_hook_cancel", 4500L, "EUR"));
