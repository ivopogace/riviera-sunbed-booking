...
/**
 * The move rule: free for the whole span, online pool, same or better tier; prefer the same row,
 * then the closest position, then the closest row; the distance is reported in rows and positions.
 * Pure unit test of the {@code domain} holder — the pool is handed in already free.
 */
