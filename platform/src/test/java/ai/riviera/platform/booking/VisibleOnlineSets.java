 ...
 * (owner {@code ACTIVE}), because the reserve path refuses a hidden venue's set — a sibling test's
 * hidden fixture venue must never be pickable here; and active-only, because a sibling test's
 * retired set is the newest row and the claim refuses it (ADR-0019).
 */
