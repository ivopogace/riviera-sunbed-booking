...
/**
 * Solves, mints and forges ALTCHA v2 challenges for the tests, with the same library the module
...
public final class ChallengeSolving {
	...
	public static String solve(String challengeJson) throws Exception {
		return solve(parse(challengeJson));
	}

	public static String solve(Altcha.Challenge challenge) throws Exception {
	...
	public static Altcha.Challenge mint(String secret, int cost, long expiresAtEpochSeconds) throws Exception {
	...
	public static String payload(Altcha.Challenge challenge, Altcha.Solution solution) {
	...
	public static String tamperSignature(String payload) throws Exception {
	...
	public static String wrongAnswer(String payload) throws Exception {
		Altcha.Payload parsed = Altcha.parsePayload(payload);
