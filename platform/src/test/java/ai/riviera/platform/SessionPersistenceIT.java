...
/**
 * Pins that sessions live in <strong>Postgres</strong>, not the servlet container (AC-4,
 * design D-1): Spring Session JDBC ({@link JdbcIndexedSessionRepository} — injected here so
