 ...
 * {total} free" without the per-set layout, and — one per day — on {@link DailyAvailability}, which
 * reuses this meaning rather than restating it. {@code free} is derived from the authoritative
