...
/**
 * The one home of the required optimistic-concurrency token contract — dedup of the copies that used
 * to live separately in {@code UpdateVenueProfileRequest}, {@code BeachMapLayoutRequest} and
