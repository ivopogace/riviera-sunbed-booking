 ...
 * cache key in the immutable serving URL (ADR-0008: {@code Cache-Control: immutable} + {@code ETag}),
 * so a replaced photo gets a new hash → a new URL, and the old URL stays immutable.
 *
