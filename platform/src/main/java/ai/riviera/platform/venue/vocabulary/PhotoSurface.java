 ...
 * authenticated, and {@code LIGHTBOX} because its box already is a DPR-2 size. A {@code LIGHTBOX}
 * row is absent altogether when the upload was too small to fill that box.
 */
