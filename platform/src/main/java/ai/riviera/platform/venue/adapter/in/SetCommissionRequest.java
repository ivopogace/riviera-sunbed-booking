...
/**
 * The {@code PUT /api/admin/venues/{venueId}/commission} request body (A7, epic #348). A transport DTO
 ...
 * {@code spring-boot-starter-validation}, so presence is checked explicitly here (#97) and the
 * controller runs the conversion through {@code InvalidApiRequestException.parsing} so a bad value is a
 * {@code 400 INVALID_REQUEST} rather than a logged 500 (#118).
 *
