 ...
 * {@link PhotoStorage#listMetadata} so the platform-admin moderation read (#511) can build the
 * immutable serving URL from the {@link ContentHash} without ever selecting the {@code bytea} column
