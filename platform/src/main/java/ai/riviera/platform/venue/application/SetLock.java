 ...
 * and the earliest hold dated today or later ({@code heldOn}). Either may be {@code null}, never
 * both — a set with neither is free and absent from the read. Price, tier and pool stay editable on
 * a locked set (RESPONSIBILITIES.md §venue). Internal to the {@code venue} module (REST-only
