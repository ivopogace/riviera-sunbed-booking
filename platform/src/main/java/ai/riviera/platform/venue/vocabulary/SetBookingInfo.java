 ...
 * #5), gate the sale on {@code salesClose} and compute free-cancellation from
 * {@code bookingCutoff} (both wall-clock {@code LocalTime} in {@code Europe/Tirane},
 * invariant #4), and build the booking confirmation summary (venue name + set label).
 *
