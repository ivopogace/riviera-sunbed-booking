 ...
 *
 * <p><strong>Dependency-inverted port (invariant #11).</strong> It is declared here, in the
 * <em>consumer</em>'s {@code api/}, and <em>implemented by the {@code availability} module</em>
 * (the sole owner/reader of {@code set_availability}). The natural call direction —
 ...
 * it keeps the graph acyclic: {@code availability → venue::api} is the existing, allowed edge,
 * and {@code venue} never imports {@code availability}. {@code ModularityTests} is the gate.
 *
