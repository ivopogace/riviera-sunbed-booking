 ...
 * never tourist-surfaced — they are visible to the venue's own operator and, since #511, to a
 * platform admin moderating them. At most one photo per {@code (venue, slot)} — a re-upload replaces.
 *
