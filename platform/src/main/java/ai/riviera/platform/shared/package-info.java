 ...
 * types the domain modules are allowed to depend on.
 *
 ...
 * directly. It may depend only on {@code customer} and {@code operator} — the two modules
 ...
 * failing any of those belongs in a module or at the composition root. <strong>This is not a
