 ...
 * ports speak in ({@link RatingSummary}, {@link CompletedStay}, {@link OwnReview}), and the closed
 * answer sets ({@link ReviewPanel}, {@link SubmitOutcome}, {@link AmendOutcome}). Value types only,
 * never ports — "call-me" interfaces
