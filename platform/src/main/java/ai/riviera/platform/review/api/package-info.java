 ...
 * its public page, and {@link ReviewTombstones}, the erasure reach {@code booking} drives for the
 * {@code customer} module's scrub — the one published write, and a scrub rather than a delete. The
 * typed ids and values these ports speak in ({@code VenueRef},
