 ...
 *
 * <p>{@code @Profile("!mailer & !smtp4dev")} so exactly one {@link Mailer} bean exists: the mock when
 * {@code mailer} is absent, {@link SmtpMailer} when it is present. {@link MockMailerProdGuard} additionally
