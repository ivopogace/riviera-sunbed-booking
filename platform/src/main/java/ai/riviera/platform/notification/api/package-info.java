 ...
 * "call-me" interfaces only, <strong>split by role</strong> (#95):
 * <ul>
 ...
 *       response's status (D-8) nor its latency (#369).</li>
 *   <li>{@link MailDeliverability} (#400) — the synchronous read "would a mail to this address be
