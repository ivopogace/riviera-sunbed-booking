 ...
 * reporting {@code Foo@Bar.com} still suppresses the checkout's {@code foo@bar.com}. Unpublished
 * application-internal port, implemented by {@code adapter/out} (invariant #11); timestamps are
 * caller-supplied UTC instants (invariant #6).
 */
