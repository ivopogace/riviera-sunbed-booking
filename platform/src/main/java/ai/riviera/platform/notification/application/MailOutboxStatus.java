...
/**
 * What the admin console shows before anyone presses anything (#405): how much mail the registry still
 * owes, and whether the lever is currently accepting.
 *
 * <p>This read is not required by #405's acceptance criteria — it exists because a resubmit button
