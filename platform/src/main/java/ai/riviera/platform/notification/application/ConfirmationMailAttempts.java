...
/**
 * The booking-confirmation mail delivery log (#380) — this module's record of what it did about each
 ...
 * log: the automatic send is idempotent through the Event Publication Registry (#371) and a resend is
