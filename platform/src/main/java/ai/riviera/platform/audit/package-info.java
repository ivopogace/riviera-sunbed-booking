 ...
 * {@code shared} kernel. The audited namespace's controllers span six bounded contexts and the
 * root, so no context can own the record over the whole namespace; a mechanism that knew a domain
 * type would be a bounded context wearing this module's clothes. The whole surface a caller sees is
