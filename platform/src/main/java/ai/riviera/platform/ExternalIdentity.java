...
/**
 * A verified external identity returned by {@link SsoGateway#exchangeCode} (S4, epic #108): the
 ...
 * verified canned identities; the real adapters (S5, #116) must assert {@code email_verified} before
