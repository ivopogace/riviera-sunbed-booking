...
/**
 * A single-provider SSO adapter (S4, epic #108) — the real per-provider integration point behind the
 ...
 * {@link UnsupportedOperationException} until client credentials ship (S5, #116); {@code RealSsoGateway}
