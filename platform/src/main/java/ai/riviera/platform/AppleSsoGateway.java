 ...
 * response mode; those details land with the credentials. Under {@code @Profile("sso")} it throws
 * {@link UnsupportedOperationException} on any use, so activating the real profile without them fails
...
class AppleSsoGateway implements SsoProviderClient {
	...
	private static final String NOT_IMPLEMENTED = "Apple SSO not implemented — awaiting client credentials";
