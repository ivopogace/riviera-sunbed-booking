 ...
 * {@link CustomerAccountCredential}, and the sealed {@link RegistrationOutcome}. Value types only —
 * the ports live in the sibling {@code api} named interface. Granted as {@code customer::vocabulary}
 * to consumers per least privilege.
 */
