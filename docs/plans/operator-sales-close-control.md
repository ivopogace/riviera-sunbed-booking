...
- [x] **AC-10:** RESPONSIBILITIES.md §`venue` rewritten (owner-editable write path; commission + payout currency remain the two mirrored write-proof fields); freshness run recorded below.
