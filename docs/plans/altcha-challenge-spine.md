...
seam, one behavior per cycle) · `riviera-review-overlay` (review gate — **ran** at ready-for-review on PR #911 via `code-review:code-review` at high effort: five generic review agents plus the overlay bank walk; findings F-5..F-8 below, all fixed) ·
