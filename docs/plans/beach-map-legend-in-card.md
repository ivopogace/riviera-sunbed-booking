...
`riviera-review-overlay` (review gate — RV-FE-E2E for suite placement, run at
...
**Next action:** Phase 3 — re-aim the #700 breakout assertion and add the mobile-order,
hatch and swatch-parity e2e cases in `frontend/e2e/venue-map-pan.e2e.ts`.
