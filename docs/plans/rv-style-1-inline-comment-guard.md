...
**Next action:** Maintainer merges, then does the one **Ready-for-human** step below (adding the
check to the `Riviera Rule Set` ruleset). Nothing else is outstanding in the diff.
