...
| F-3 | CI (Backend, head `be6c178`) | `RateLimitFilterTest` registered with `password123` (11) and expected `201`; the `@WebMvcTest` runs the controller, so the floor answered `400` | fixed — fixture → `passphrase-123`; class green locally (42) |
