...
- **B-13..B-19 (the sparse-tail wave, 155 files, comment-only `#nnn` strip)** — a large mechanical
  ...
  for that scale:
  - B-13 (22 files): `platform/src/test/java/ai/riviera/platform/booking/adapter/in/{RefundListenerExecutorArchitectureTest,RefundExecutorPropertiesTest,RefundExecutorConfigTest}.java`, `platform/src/test/java/ai/riviera/platform/booking/application/request/{RequestWindowsTest,PaymentDueAnnouncerIT}.java`, `platform/src/test/java/ai/riviera/platform/booking/application/view/ViewBookingServiceTest.java`, `platform/src/test/java/ai/riviera/platform/customer/CustomerDirectoryIT.java`, `platform/src/test/java/ai/riviera/platform/customer/adapter/in/GuestContactRetentionSchedulerConfigTest.java`, `platform/src/test/java/ai/riviera/platform/notification/MailSenderWiringIT.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/in/{RegistryMailExecutorWiringIT,MailResubmissionPropertiesTest,MailListenerExecutorArchitectureTest}.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/out/EmailSuppressionReinstatementIT.java`, `platform/src/test/java/ai/riviera/platform/notification/application/{MailTransportBudgetTest,MailKindTest,MailDeliverabilityServiceTest}.java`, `platform/src/test/java/ai/riviera/platform/payout/adapter/in/AdminPayoutBatchControllerTest.java`, `platform/src/test/java/ai/riviera/platform/venue/{VenueSeedMigrationIT,JdbcPhotoStorageIT,BeachMapReplaceConcurrencyIT,AdminVenueCommissionIT,AdminPhotoTakedownIT}.java`
  - B-14 (22 files): `platform/src/test/java/ai/riviera/platform/{TestcontainersConfiguration,SessionLoginSupport,ScheduledWorkArchitectureTest,ScheduledQueryTimeoutBoundsTest,PostgresContainerConfiguration,OperatorApprovalIT,MeSurfaceRoleGateTest,ErrorContractArchitectureTests}.java`, `platform/src/test/java/ai/riviera/platform/booking/adapter/in/BookingListenerIds.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/out/SuppressionQueryTimeoutIT.java`, `platform/src/test/java/ai/riviera/platform/notification/application/{SuppressionReinstatementServiceTest,MailResubmissionServiceTest,BookingMailFactsServiceTest,BookingConfirmationResendServiceTest}.java`, `platform/src/test/java/ai/riviera/platform/payment/adapter/out/StripeConfigTest.java`, `platform/src/test/java/ai/riviera/platform/payout/PayoutReversalIT.java`, `platform/src/test/java/ai/riviera/platform/payout/adapter/in/BookingCancelledPayoutListenerTest.java`, `platform/src/test/java/ai/riviera/platform/venue/VenueRepriceConcurrencyIT.java`, `platform/src/test/java/ai/riviera/platform/venue/adapter/in/AdminVenueCommissionControllerTest.java`, `platform/src/test/java/ai/riviera/responsibilityfixture/package-info.java`, `platform/src/test/java/ai/riviera/rootfixture/package-info.java`, `platform/src/test/java/ai/riviera/workercontextfixture/UndecoratedWorkerPool.java`
  - B-15 (22 files): `platform/src/test/java/ai/riviera/platform/{VenueApiRoleSplitTests,SsoRateLimitIT,SsoCallbackIT,RealSsoGatewayTest,PerUsernameLoginThrottleIT,PasswordResetIT,OperatorSuspensionRevocationIT,OperatorRegistrationIT}.java`, `platform/src/test/java/ai/riviera/platform/availability/StaffAvailabilityIT.java`, `platform/src/test/java/ai/riviera/platform/booking/{RequestToBookFlowIT,MyBookingsIT}.java`, `platform/src/test/java/ai/riviera/platform/booking/adapter/in/BookingCreationViewsContractTest.java`, `platform/src/test/java/ai/riviera/platform/booking/adapter/out/JdbcCustomerBookingsIT.java`, `platform/src/test/java/ai/riviera/platform/customer/CustomerAccountRecoveryIT.java`, `platform/src/test/java/ai/riviera/platform/customer/adapter/in/CustomerRetentionPropertiesTest.java`, `platform/src/test/java/ai/riviera/platform/customer/application/CustomerAccountServiceTest.java`, `platform/src/test/java/ai/riviera/platform/notification/{RequestExpiredMailIT,RequestDeclinedMailIT,BookingCancellationMailIT}.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/in/{MailListenerRuleFixtures,BookingCancellationMailListenerTest}.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/out/MailOutboxScopeTest.java`
  - B-16 (22 files): `platform/src/test/java/ai/riviera/platform/{OperatorCredentialInitializerTest,OperatorAuthPlacementTests,MyVenuesIT,CustomerRoleSeparationIT,CustomerRegisterIT,CustomerLoginIT,AdminEmailSuppressionControllerTest,AdminAuditTrailIT}.java`, `platform/src/test/java/ai/riviera/platform/payout/PayoutLedgerViewIT.java`, `platform/src/test/java/ai/riviera/platform/shared/ShutdownBudgetTest.java`, `platform/src/test/java/ai/riviera/platform/venue/{VenueSetWriteConcurrencyIT,VenueProfileConcurrencyIT,VenueCommissionScheduleMigrationIT,VenueAmenityMigrationIT,SetBookingInfoIT,JdbcVenueCommissionScheduleIT,BookingModeSwitchIT}.java`, `platform/src/test/java/ai/riviera/platform/venue/adapter/in/PhotoSlotsTest.java`, `platform/src/test/java/ai/riviera/platform/venue/application/{VenueProfileCommandTest,RowPriceCommandTest,PhotoProcessorTest,DailyAvailabilityServiceTest}.java`
  - B-17 (22 files): `platform/src/test/java/ai/riviera/platform/customer/{SsoAccountVerifiedIT,SsoAccountProvisioningIT}.java`, `platform/src/test/java/ai/riviera/platform/customer/application/AccountErasureServiceTest.java`, `platform/src/test/java/ai/riviera/platform/customer/vocabulary/EmailsTest.java`, `platform/src/test/java/ai/riviera/platform/notification/{RequestPaymentDueMailIT,ListenerMoveMigrationIT,ControllableMailerConfiguration}.java`, `platform/src/test/java/ai/riviera/platform/notification/adapter/out/{SuppressionPepperProdGuardTest,SuppressedConfirmationMailDeliveryTest,MockMailerTest,MockMailerProdGuardTest,MailerProfileWiringTest}.java`, `platform/src/test/java/ai/riviera/platform/notification/application/{SynchronousMailDispatch,MailDeliveryLookupServiceTest,ConfirmationAttemptRecorderTest,BookingLinksTest}.java`, `platform/src/test/java/ai/riviera/platform/operator/OperatorAccountProvisioningIT.java`, `platform/src/test/java/ai/riviera/platform/payment/EventRegistryMigrationIT.java`, `platform/src/test/java/ai/riviera/platform/payment/adapter/in/StripeWebhookListenerFailureIT.java`, `platform/src/test/java/ai/riviera/platform/payment/application/RefundFailureMetricTest.java`, `platform/src/test/java/ai/riviera/platform/payout/{PayoutBatchLifecycleTest,PayoutBatchGenerationIT}.java`
  - B-18 (22 files): `platform/src/test/java/ai/riviera/platform/{WebCorsConfigTest,WebCorsConfigEmptyOriginsTest,TokenBucketTest,StructuredLoggingIT,SpaShellTest,SpaFallbackResolverTest,SessionPersistenceIT}.java`, `platform/src/test/java/ai/riviera/platform/availability/{StaffMarkVsOnlineClaimConcurrencyIT,StaffAvailabilityControllerIT,AvailabilityLookupIT}.java`, `platform/src/test/java/ai/riviera/platform/booking/{WithdrawRequestIT,WeatherRefundSecurityIT,CreateBookingPaymentFailureIT}.java`, `platform/src/test/java/ai/riviera/platform/booking/adapter/in/{RequestPropertiesTest,RefundResubmissionPropertiesTest,RefundListenerRuleFixtures}.java`, `platform/src/test/java/ai/riviera/platform/booking/adapter/out/JdbcBookingsAccountLinkIT.java`, `platform/src/test/java/ai/riviera/platform/booking/application/refund/{RefundResubmissionServiceTest,AbandonedBookingSweepServiceTest}.java`, `platform/src/test/java/ai/riviera/platform/booking/application/request/{WithdrawRequestServiceTest,PendingRequestsServiceTest}.java`, `platform/src/test/java/ai/riviera/platform/customer/JdbcCustomerAccountsIT.java`
  - B-19 (23 files): `platform/src/test/java/ai/riviera/drainfixture/OversizedDrainingPool.java`, `platform/src/test/java/ai/riviera/placementfixture/package-info.java`, `platform/src/test/java/ai/riviera/placementfixture/consumer/adapter/in/BadDecomposedListener.java`, `platform/src/test/java/ai/riviera/platform/{RecoveryRateLimitIT,RecoveryMailerFailureIT,RateLimitDisabledTest,RateLimitDefaultsTest,PackageShapeArchitectureTests,OutboxBacklogGaugeIT,OperatorApprovalMailTest,OperatorApprovalMailIT,MyVenuesControllerTest,MoneyPathAlertCheckTest,MockSsoProdGuardTest,MockSsoGatewayTest,HttpServerRequestMetricsIT,EndpointProbes,CsrfCookieBootstrapIT,CorrelationIdFilterTest,AdminRefundOutboxControllerTest,AdminErasureControllerTest,AdminAuditReasonsTest,AbandonedSweepSurvivesWedgedJobIT}.java`
