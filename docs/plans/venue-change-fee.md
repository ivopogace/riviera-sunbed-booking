...
- `platform/src/main/java/ai/riviera/platform/payout/adapter/in/AdminPayoutLedgerController.java` — the ledger read now returns fees too
- `frontend/src/app/operator/operator-console.service.ts` — the same enumeration on the client
