...
with #1201; D10 (the venue maximum stay) landed with #1204; the rest is not yet built.** Decisions below were made at the refine stage (2026-09-12/13) against `main` @
