...
The nine bounded-context Spring-Modulith modules and how they collaborate (the three non-context modules — `shared`, `challenge` and `audit` — collaborate with nobody and are not drawn). **Solid arrows = domain
