...
2. [`docs/architecture/domain-model.md`](docs/architecture/domain-model.md) — the
   module map, the tables and types each module owns, the core flows and the state
   machines, as diagrams. This is the fastest way to load the mental model.
...
an added `riviera-*` skill line (RV-STYLE-1),
