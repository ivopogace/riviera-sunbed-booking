 ...
 * every test file; the `afterEach` below fails a test that leaves it drifted. Register it in
 * `vitest-base.config.ts`, never `angular.json` (the builder's shim skips this body): ADR-0014.
 */
