...
// shared/card-glass.ts. A directive, not a mixin: Tailwind has no CSS-level sharing primitive, so a
// surface recipe applied to arbitrary hosts moves to the directive layer (riviera-tailwind rule 1).
