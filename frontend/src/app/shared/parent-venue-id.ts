 ...
 * constructor). Generalized to any param name at #499 (the tourist map's `:id`).
 */
 ...
 * do not inherit the param under the router's default `emptyOnly` strategy (the O1 finding).
 * Extracted at O5 (#175).
 */
