...
@Component({
  ...
  template: `
    <button
      appTouchTarget
      type="button"
      class="cursor-pointer rounded-2xl border border-riv-cta-border bg-(image:--riv-cta-grad) px-6.5 py-3 text-[14.5px] font-bold text-white shadow-[0_10px_26px_rgba(11,120,150,0.5),inset_0_1px_0_rgba(255,255,255,0.5)] transition hover:brightness-[1.06] motion-reduce:transition-none focus-visible:shadow-[0_0_0_7px_color-mix(in_srgb,var(--riv-accent-ink)_90%,transparent)] focus-visible:outline-[3px] focus-visible:outline-white focus-visible:outline-offset-2"
