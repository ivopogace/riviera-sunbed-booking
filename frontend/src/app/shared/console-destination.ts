...
/**
 * The venue console's landing tab: `/operator/:venueId` redirects here, and the venue switcher and
 * palette assume it mid-redirect (off the console the palette falls back to it, the switcher links
 * `/operator/<id>`). One constant keeps them in step. Rationale: RESPONSIBILITIES.md §Frontend.
 */
