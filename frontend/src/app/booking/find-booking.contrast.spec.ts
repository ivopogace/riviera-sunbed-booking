...
/**
 * WCAG-AA contrast guard for the Liquid Glass "Find a booking" modal (issue #148, AC-12). The modal
 ...
 * find-booking.scss.
 *
 * Deviations from the design file, on purpose (plan R-5, cloned from booking-dialog): the panel is
