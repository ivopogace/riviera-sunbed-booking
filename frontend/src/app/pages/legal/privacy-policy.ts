...
/**
 * The hosted privacy-policy document (#101 Slice 3) at `/legal/privacy` — the target of the
 * checkout agreement links and the footer link.
 *
 * <p><strong>Deliberately a DRAFT.</strong> The final text is #101's counsel-gated remainder
 ...
 * #101 Slices 1–2), the automated retention sweep, and the single strictly-necessary session
