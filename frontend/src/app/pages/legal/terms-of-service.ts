 ...
 * A DRAFT under the same rule as `PrivacyPolicy`: banner + [bracketed] placeholders until the
 ...
 * or the evening-before cancellation deadline (#4, #10; both per venue, the UI shows a default), a
