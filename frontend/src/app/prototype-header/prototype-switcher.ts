...
import { PrototypeHeaderVariant } from './prototype-header-variant';
  ...
  template: `
    @if (devMode) {
      <div
        ...
        [class]="variants.variant() === 'c' ? 'max-sm:bottom-[76px]' : ''"
      ...
      >
        ...
        <span class="min-w-[220px] text-center whitespace-nowrap" aria-live="polite">
...
export class PrototypeSwitcher {
  ...
  protected readonly variants = inject(PrototypeHeaderVariant);
