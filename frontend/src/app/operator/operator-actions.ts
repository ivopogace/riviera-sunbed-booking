...
@Component({
  ...
  template: `
    ...
    <button
      type="button"
      appTouchTarget
      class="cursor-pointer rounded-full border border-riv-console-btn-border bg-white px-3.75 py-1.75 font-sans text-[13px] font-semibold text-riv-ink shadow-[0_1px_2px_rgba(7,42,58,0.08)] transition-colors hover:bg-riv-console-btn-hover motion-reduce:transition-none"
