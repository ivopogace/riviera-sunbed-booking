 ...
 * as text (not colour alone) with the clock icon `aria-hidden`, and the expired-race notice is an
 * `<output>` with the alert icon `aria-hidden`. axe runs over the populated queue, an open
