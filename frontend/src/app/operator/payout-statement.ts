...
@Component({
  ...
  host: {
    class:
      'fixed inset-0 z-[60] flex items-start justify-center overflow-y-auto bg-riv-console-scrim/45 px-5 py-8',
  ...
  template: `
    ...
    >
      <div
        class="flex items-center justify-between gap-3 border-b border-riv-console-tint/10 px-6 py-4"
      >
